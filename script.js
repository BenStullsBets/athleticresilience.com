/* Athletic Resilience — minimal progressive enhancement */
(function () {
  "use strict";
  ...
  /* Newsletter / contact form — submits to Web3Forms via fetch, no page reload */
  ...
  if (form) {
    ...
    var EMAIL = "hello@athleticresilience.com";
    ...
    form.addEventListener("submit", function (e) {
      ...
      if (!configured) {
        if (status) {
          ...
          status.innerHTML = "The form isn't live yet. Please email " +
      ...
      fetch(form.action, {
        ...
        .then(function (r) {
          if (r.ok && r.j && r.j.success) {
            ...
            done.innerHTML = "<strong>You're in — thanks!</strong> Watch your inbox for tips and updates.";
        ...
        .catch(function (err) {
          if (window.console && console.error) {
            console.error("Form submission failed:", (err && err.message) || err);
          }
          if (status) {
            status.className = "form-status err";
